...
<body>
<div align="center"><a href="?pg=cadastrar_empresa" style="text-decoration:none; color:#FF0000; " rel="deactivate"><strong>&Aacute;REA RESTRITA</strong></a></div><BR>
<center>

<? echo $id_vaga=$_GET['id'];  ?> 


<form method="POST"  action="?pg=valida_usuario_restrito" class="login"  NAME="regform"
