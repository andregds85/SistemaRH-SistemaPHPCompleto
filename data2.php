...
<input TYPE="button" NAME="btnData1" VALUE="Data de Nascimento" Onclick="javascript:popdate('document.regform.data1','pop1','150',document.regform.data1.value)">
<!-- 
...
<br><br>      
<!-- data 2 --><!-- na span abaixo aparece o segundo calendario -->
